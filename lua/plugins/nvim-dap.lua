      ...
      specs = {
        {
          ...
          opts = function(_, opts)
            ...
            maps.n["<Leader>dh"] = { function() require("dap-view").hover() end, desc = "Debugger Hover" }
            maps.n["<Leader>dw"] = { "<Cmd>DapViewWatch<CR>", desc = "Add to Watches" }
            maps.v["<Leader>dw"] = { "<Cmd>DapViewWatch<CR>", desc = "Add to Watches" }
